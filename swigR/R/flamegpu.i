...
// argc/argv support @TODO: commandArgs (R)
// %include <argcargv.i> 

// Swig exception support
// %include <exception.i>

// // Enable the use of argc/argv @TODO: commandArgs (R)
 ...
 */
// @TODO: deal with exceptions in R
...
//         PyObject *err = SWIG_NewPointerObj(except, SWIGTYPE_r_FLAMEGPURuntimeException, 1);
//         SWIG_Python_Raise(err, except.type(), SWIGTYPE_r_FLAMEGPURuntimeException); 
//         SWIG_fail;
//     }
...
%rename(get) flamegpu::AgentVector::operator[]; 
%rename(get) flamegpu::RunPlanVector::operator[]; 

%rename(_function) flamegpu::LoggingConfig::NameReductionFn::function;
