...
class AgentRandom {
 public:
     ...
     */
    __forceinline__ __device__ AgentRandom(curandStatePhilox4_32_10_t *d_rng);
    /**
 ...
 private:
     ...
     */
    curandStatePhilox4_32_10_t *d_random_state;
};

__forceinline__ __device__ AgentRandom::AgentRandom(curandStatePhilox4_32_10_t *d_rng) : d_random_state(d_rng) { }
/**
